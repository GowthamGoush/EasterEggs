...
var _toad = require("./toad");
var _toadDefault = parcelHelpers.interopDefault(_toad);
var _commonUtils = require("../utils/common_utils");
var _gameUtils = require("../utils/game_utils");
class Game {
    constructor(canvas){
        this.canvas = canvas;
    ...
    init() {
        ...
        obstaclesPositions.forEach((position)=>{
            this.obstacles.push(new (0, _obstacleDefault.default)(this, position));
        });
        this.addToads();
    }
    addEgg() {
        this.eggs.push(new (0, _eggDefault.default)(this));
    }
    addToads() {
        for(let count = 0; count < this.toadCountMax; count++)this.toads.push(new (0, _toadDefault.default)(this));
    }
    removeGameObjects() {
     ...
     */ gameObjects.sort((objectA, objectB)=>objectA.collisionY - objectB.collisionY);
        ...
        if ((0, _gameUtils.isGameOver)({
            ...
            context.fillStyle = "white";
            context.textAlign = "center";
            const { title, description, restartText } = (0, _gameUtils.getGameOverContent)({
                score: this.score,
                lostHatchlings: this.lostHatchlings
            });
...
},{"./player":"fnthN","./obstacle":"70aMT","./egg":"4U5lW","./toad":"UuOyI","../utils/common_utils":"7stP0","../utils/game_utils":"2KYHo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fnthN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Player", ()=>Player);
var _playerUtils = require("../utils/player_utils");
class Player {
    constructor(game){
        this.game = game;
    ...
    update() {
        ...
        this.frameY = (0, _playerUtils.getPlayerPositionIndex)(this.dx, this.dy);
...
},{"../utils/player_utils":"1o5CG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1o5CG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getPlayerPositionIndex", ()=>getPlayerPositionIndex);
const getPlayerPositionIndex = (dx, dy)=>{
...
},{}],"70aMT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Obstacle {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4U5lW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _larva = require("./larva");
var _larvaDefault = parcelHelpers.interopDefault(_larva);
class Egg {
    constructor(game){
        this.game = game;
    ...
    update(deltaTime) {
        ...
        if ((this.hatchTimer > this.hatchInterval || this.collisionY < this.game.topMargin) && !this.game.over) {
            this.game.hatchlings.push(new (0, _larvaDefault.default)(this.game, this.collisionX, this.collisionY));
...
},{"./larva":"ip17j","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ip17j":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Larva {
...
exports.default = Larva;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"UuOyI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Toad {
    constructor(game){
...
exports.default = Toad;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7stP0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "drawText", ()=>drawText);
const drawText = ({ context, content, posX, posY, align, fontStyle })=>{
    context.font = fontStyle;
    context.textAlign = align;
    context.fillText(content, posX, posY);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2KYHo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getRandomPositionArray", ()=>getRandomPositionArray);
parcelHelpers.export(exports, "isGameOver", ()=>isGameOver);
parcelHelpers.export(exports, "getGameOverContent", ()=>getGameOverContent);
var _gameConstants = require("../constants/game_constants");
const getRandomPositionArray = ({ gameWidth, gameHeight, verticalMargin = 0, horizontalMargin = 0, size, count, distanceBuffer = 0 })=>{
    let positions = [];
...
const isGameOver = ({ score = 0, lostHatchlings = 0 })=>{
    return score >= (0, _gameConstants.WINNING_SCORE) || lostHatchlings >= (0, _gameConstants.LOSING_SCORE);
};
const getGameOverContent = ({ score = 0, lostHatchlings })=>{
    const restartText = "Press 'R' to restart the game";
    if (score >= (0, _gameConstants.WINNING_SCORE)) return {
        title: "AWESOME!!!",
        description: `You nailed it with ${score} points!`,
        restartText
    };
    if (score >= Math.floor((0, _gameConstants.WINNING_SCORE) * 0.9)) return {
        title: "SO CLOSE!!!",
...
},{"../constants/game_constants":"5a6TF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5a6TF":[function(require,module,exports) {
/**
 *  Minimum required score for victory
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WINNING_SCORE", ()=>WINNING_SCORE);
parcelHelpers.export(exports, "LOSING_SCORE", ()=>LOSING_SCORE);
const WINNING_SCORE = 30;
const LOSING_SCORE = 15;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3lsJq","1xC6H","bNKaB"], "bNKaB", "parcelRequireb741")
